                ...
                <div class="product-single-img">
                    <div class="product-active owl-carousel">
                        ...
                        @foreach ($product->productImages as $image)
                            <div class="item">
                                <img src="{{ asset('uploads/products') }}/{{ $image->product_multiple_image }}" alt="">
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="col-lg-6">
                <div class="product-single-content">
                    ...
                    <ul class="input-style">
                        <form action="{{ route('add_to.cart') }}" method="post">
                            ...
                            <li>
                                <button type="submit" class="btn btn-danger ml-4">Add to Cart</button>
                            </li>
                        </form>
                    </ul>
                    <ul class="cetagory">
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="featured-product-wrap">
                    ...
                    <div class="featured-product-content">
                        <div class="row">
                            <div class="col-7">
                                <h3><a href="{{ route('single.product', ['slug' => $rproduct->slug]) }}">{{ $rproduct->name }}</a></h3>
