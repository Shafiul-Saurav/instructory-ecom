...
@section('admin_content')
    <div class="row">
        ...
        <div class="col-12 mt-4">
            <div class="card p-4">
                <form action="{{ route('post.update', $post->post_slug) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group mb-3">
                                ...
                                @enderror">
                                    @foreach ($postCategories as $postCategory)
                                        ...
                                        @if ($postCategory->id == $post->pcategory_id)
                                            selected
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="subcategory_id" id="subcategory_id" class="form-select">
                                    ...
                                    @foreach ($postSubcategories as $postSubcategory)
                                        <option value="{{ $postSubcategory->id }}"
                                        @if ($postSubcategory->id == $post->subcategory_id)
                                            selected
                                        @endif>{{ $postSubcategory->subcategory_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="post_description" id="" cols="30" rows="5" class="form-control">{{ $post->post_description }}</textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mt-4">
                                ...
                                data-default-file="{{ asset('uploads/posts') }}/{{ $post->post_image }}">
                                @error('post_image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-12">
                            <div class="form-check form-switch mt-4">
                                <input class="form-check-input" name="is_approved" type="checkbox" role="switch" id="activeStatus"
                                @if ($post->is_approved)
                                    checked
                                @endif>
