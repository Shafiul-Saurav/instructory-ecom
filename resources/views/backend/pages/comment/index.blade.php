...
@section('admin_content')
    <div class="row">
        ...
        <div class="col-12">
            <div>
                <a href="{{ route('post_comment.trash') }}" class="btn btn-info">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li>
                                                <form action="{{ route('post_comment.update', $comment->id) }}" method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="d-flex p-3">
                                                        ...
                                                        <div>
                                                            <button type="submit" class="btn btn-primary"><i class="fas fa-smile"></i> Approved</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </li>
                                            <hr>
                                            <li>
                                                <form action="{{ route('post_comment.destroy', $comment->id ) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
