                        ...
                        <div class="col-12">
                            <div class="form-group mt-4">
                                ...
                                <input type="text" name="product_name" class="form-control @error('product_name')
                                    is-invalid
                                @enderror" placeholder="Enter Product Name" value="{{ old('product_name') }}">
                                @error('product_name')
                        ...
                        <div class="col-6">
                            <div class="form-group mt-4">
                                ...
                                <input type="number" name="product_price" class="form-control @error('product_price')
                                    is-invalid
                                @enderror" min="0" value="{{ old('product_price') }}">
                                @error('product_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-6">
                            <div class="form-group mt-4">
                                ...
                                <input type="text" name="product_code" class="form-control @error('product_code')
                                    is-invalid
                                @enderror" placeholder="Enter a Unique Product Code" value="{{ old('product_code') }}">
                                @error('product_code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-6">
                            <div class="form-group mt-4">
                                ...
                                <input type="number" name="product_stock" class="form-control @error('product_stock')
                                    is-invalid
                                @enderror" min="1" value="{{ old('product_stock') }}">
                                @error('product_stock')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-6">
                            <div class="form-group mt-4">
                                ...
                                <input type="number" name="alert_quantity" class="form-control @error('alert_quantity')
                                    is-invalid
                                @enderror" min="1" value="{{ old('alert_quantity') }}">
                        ...
                        <div class="col-12">
                            <div class="form-group mt-4">
                                ...
                                <textarea name="short_description" class="form-control @error('short_description')
                                    is-invalid
                                @enderror" id="" cols="30" rows="5">{{ old('short_description') }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group mt-4">
                                ...
                                <textarea name="long_description" class="form-control @error('long_description')
                                    is-invalid
                                @enderror" id="" cols="30" rows="5">{{ old('long_description') }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group mt-4">
                                ...
                                <textarea name="additional_info" class="form-control @error('additional_info')
                                    is-invalid
                                @enderror" id="" cols="30" rows="5">{{ old('additional_info') }}</textarea>
