...
@section('admin_content')
    <div class="row">
        <h1>{{ __('Product List Table') }}</h1>
        <div class="col-12">
            <div class="d-flex justify-content-between">
                <a href="{{ route('product.trash') }}" class="btn btn-info">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item" href="{{ route('product.edit', $product->slug) }}"><i class="fa-regular fa-pen-to-square"></i> Edit</a></li>
                                            <li>
