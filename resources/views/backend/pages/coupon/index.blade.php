...
@section('admin_content')
    <div class="row">
        <h1>{{ __('Coupon List Table') }}</h1>
        <div class="col-12">
            <div class="d-flex justify-content-between">
                <a href="{{ route('coupon.trash') }}" class="btn btn-info">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item" href="{{ route('coupon.edit', $coupon->id) }}"><i class="fa-regular fa-pen-to-square"></i> Edit</a></li>
                                            <li>
